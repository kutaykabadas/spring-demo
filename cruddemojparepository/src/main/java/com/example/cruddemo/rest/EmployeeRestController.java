...
import com.example.cruddemo.service.IEmployeeService;
...
public class EmployeeRestController {
	...
	@Autowired
	public EmployeeRestController(@Qualifier("employeeService") IEmployeeService employeeService,
	...
	public Employee pathEmployeeById(@PathVariable int employeeId, @RequestBody Map<String, Object> patchPayload) {
		Employee employee = employeeService.findById(employeeId);
		...
		if (patchPayload.containsKey("id")) {
			throw new RuntimeException("Id not allowed on Patch");
		}
	...
	private Employee apply(Map<String, Object> patchPayload, Employee employee) {
		...
		// Convert the patchPayload to Json object node
